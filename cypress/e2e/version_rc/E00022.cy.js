...
describe("Test feature pages", () => {
  ...
  it("Escenario 022: Crear Page con contenido corrupto html generedo online", () => {
    //Given usuario logueado
    PagesPage.goToPages();
    cy.screenshot("../../ghost-5.96/E00022-0-RC");
    ...
    cy.wait(500);
    cy.screenshot("../../ghost-5.96/E00022-1-RC");
    ...
    cy.screenshot("../../ghost-5.96/E00022-2-RC");
  });
});
