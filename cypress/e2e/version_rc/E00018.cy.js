...
describe("Escenarios E2E para Ghost", function () {
  beforeEach(() => {
    cy.fixture('properties.json').then((data) => {
      ...
      LogIn.logInButton();
      cy.screenshot('../../ghost-5.96/E0018-0-BS');
      cy.wait(1000);
    });
  });
  ...
  it("E0018 - Validación de Email Inválido y Longitud de Nota", function () {
    ...
    cy.wait(2000);
    cy.screenshot('../../ghost-5.96/E0018-1-BS');

    MembersPage.getScreenTitle().should("include.text", "Members");
    cy.screenshot('../../ghost-5.96/E0018-2-BS');

    MembersPage.clickNewMemberButton();
    cy.wait(2000);
    cy.screenshot('../../ghost-5.96/E0018-3-BS');
    ...
    cy.screenshot('../../ghost-5.96/E0018-4-BS');

    MembersPage.fillMemberForm(memberData);
    cy.screenshot('../../ghost-5.96/E0018-5-BS');

    MembersPage.clickSaveButton();
    cy.wait(3000);
    cy.screenshot('../../ghost-5.96/E0018-6-BS');

    MembersPage.getInvalidEmailMessageElement().should(
      "contain.text",
      "Invalid Email."
    );
    cy.screenshot('../../ghost-5.96/E0018-7-BS');
    ...
    cy.screenshot('../../ghost-5.96/E0018-8-BS');
